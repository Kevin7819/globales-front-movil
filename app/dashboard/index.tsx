  ...
  return (
    <ScrollView style={styles.container}>
          ...
          <Card key={trip.id}>
            <View style={styles.rowBetween}>
              <View>
                <Text style={styles.cardTitle}>
                  <Ionicons name="location-outline" size={16} color="#2563EB" /> {trip.destination}
                </Text>
            ...
            <View style={{ marginTop: 12 }}>
              <Text style={styles.progressLabel}>
                <Ionicons name="shield-checkmark-outline" size={14} color="#16A34A" /> Salud
              </Text>
              <Progress value={trip.healthScore} color="#16A34A" />
              <Text style={styles.progressDesc}>{trip.healthScore}% preparado</Text>
            </View>

            <View style={{ marginTop: 12 }}>
              <Text style={styles.progressLabel}>
                <Ionicons name="heart-outline" size={14} color="#DC2626" /> Cultural
              </Text>
              <Progress value={trip.culturalScore} color="#DC2626" />
              <Text style={styles.progressDesc}>{trip.culturalScore}% preparado</Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              >
                <Text style={[styles.buttonText, { color: "#2563EB" }]}>Detalles</Text>
              </TouchableOpacity>
            </View>
          </Card>
        ))}
      ...
      <View style={styles.section}>
        ...
        <View style={styles.quickRow}>
          <TouchableOpacity style={styles.quickCard} onPress={() => router.push("/map")}>
            ...
            <Text style={styles.quickDesc}>Descubre información sobre cualquier país</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.quickCard} onPress={() => router.push("/chat")}>
            ...
            <Text style={styles.quickDesc}>Resuelve dudas sobre tu viaje</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.quickCard} onPress={() => router.push("/health")}>
            <Ionicons name="shield-checkmark-outline" size={32} color="#DC2626" />
            <Text style={styles.quickTitle}>Chequeo de Salud</Text>
            <Text style={styles.quickDesc}>Verifica requisitos sanitarios</Text>
          </TouchableOpacity>
        </View>
      </View>
        ...
        {alerts.map((alert) => (
          <Card key={alert.id}>
            ...
            <Text style={styles.alertDate}>
              <Ionicons name="time-outline" size={12} color="#9CA3AF" /> {alert.date}
            </Text>
          </Card>
        ))}
      </View>
      ...
      <View style={styles.section}>
        ...
        <Card>
          <View style={styles.row}>
            <Avatar src={user.avatar} fallback="JP" size={48} />
            <View style={{ marginLeft: 12 }}>
              <Text style={styles.profileName}>{user.name}</Text>
              <Text style={styles.profileEmail}>{user.email}</Text>
            </View>
          </View>
          <Text>País: {user.country}</Text>
          <Text>Tipo de viaje: {user.travelType}</Text>
          <TouchableOpacity
